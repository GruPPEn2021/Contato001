...
uint8_t broadcastAddress[] = {0xB0, 0xA7, 0x32, 0xDE, 0xAF, 0x18}; // MUDAR O MIDImessage.id sempre que mudar o endereço de base
...
// Base 10 ---- 0x8C, 0x4B, 0x14, 0xDA, 0xC7, 0x3C
// Base 11 ---- 0xB0, 0xA7, 0x32, 0xDC, 0xDD, 0x88 (INTERFACE)
